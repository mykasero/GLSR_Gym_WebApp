...
class Profile(models.Model):
    ...
    email = models.EmailField(db_column="Adres Email",
                              default="twoj_email@gmail.com")
    date_joined = models.DateTimeField(db_column="Data dołączenia",
                                       default="2024-09-01") 
    profile_picture = models.ImageField(db_column="Zdjęcie profilowe",
                                        upload_to='media/pfps/',
                                        default='media/pfps/blank_user.png')
