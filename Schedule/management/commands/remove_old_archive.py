...
# Custom management command for removing archived bookings older than 1 month, used manually due to heroku scheduler limitations
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # If there are any such records, start looping over them and deleting + counting how many were deleted
